...
CLI 사용법:
  uv run python -m src.ingest.ontology.builder \\
...
from src.ingest.ontology.edge_detector import detect_candidates
from src.ingest.ontology.edge_extractor import extract_edges
from src.ingest.ontology.md_parser import parse_markdown
from src.ingest.ontology.models import OntologyEdge, OntologyGraph
from src.ingest.ontology.resolver import resolve_edges
